...
Q_CONSTINIT static const qt_meta_stringdata_CLASSTDiceTHreadENDCLASS_t qt_meta_stringdata_CLASSTDiceTHreadENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 15),  // "new_motor_angle"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 8),  // "motor_id"
        QT_MOC_LITERAL(38, 5),  // "angle"
        QT_MOC_LITERAL(44, 15)   // "handleReadyRead"
    },
    "TDiceTHread",
    "new_motor_angle",
    "",
...
void TDiceTHread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->new_motor_angle((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &TDiceTHread::new_motor_angle; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TDiceTHread::new_motor_angle(int _t1, int _t2)
{
